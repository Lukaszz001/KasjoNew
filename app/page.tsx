...
export default function Page() {
  ...
  return (
    <>
      {/* HeadTitle – ustawia tytuł zakładki */}
      <HeadTitle title="Don Kasjo — Bonusy, Streamy, Społeczność" />
      <Head>
        <meta name="description" content="Bonusy kasynowe, streamy i społeczność Don Kasjo" />
      </Head>
